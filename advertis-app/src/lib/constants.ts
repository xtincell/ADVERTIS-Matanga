...
export const PHASES = ["fiche", "audit", "implementation", "cockpit", "complete"] as const;
...
> = {
  ...
  audit: {
    title: "Audit",
    description: "Analyse SWOT et validation marché (R+T)",
    pillars: ["R", "T"],
    order: 2,
    icon: "Search",
  },
  implementation: {
    title: "Implémentation",
    description: "Génération des 6 rapports stratégiques",
    pillars: ["I"],
    order: 3,
    icon: "FileText",
  },

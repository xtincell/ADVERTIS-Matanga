...
function Step3FicheDeMarque({
  ...
  if (inputMethod === "import") {
    // No import result yet — show upload zone
    if (!importResult) {
      return (
        <div className="mx-auto max-w-3xl space-y-6">
          <div className="text-center">
    ...
    // Import result exists — show mapping preview
    return (
  ...
  // Form mode — existing interview data entry with A-D-V-E only
  const schema =
    interviewMode === "express" ? getPriorityVariables() : getInterviewSchema();
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <div>
              ...
              <p className="font-medium">
                {inputMethod === "form" ? "Saisie manuelle" : "Import de fichier"}
              </p>
            </div>
          </div>
        </CardContent>
    ...
    try {
      ...
      await updateInterviewData.mutateAsync({
        ...
        data: {
          ...
          _meta: {
            inputMethod,
            interviewMode: inputMethod === "form" ? interviewMode : "import",
          },
        },
      });
